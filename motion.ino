...
const char* ssid = "InfinixNOTE"; //--> Enter your SSID / your WiFi network name.
const char* password = "kylakendra"; //--> Enter your WiFi password.
/* ======================================== */

/* ======================================== Variables for telegram bot tokens. */
String BOTtoken = "7224161457:AAGrHlLr62xHn0uiwN7J5nhGxpYPgnIqX_A";  //--> your Bot Token (Get from Botfather).
/* ======================================== */

/* ======================================== @myidbot ID */
// Use @myidbot to find out the chat ID of an individual or a group.
// Also note that you need to click "start" on a bot before it can message you.
String CHAT_ID = "1223764195";
/* ======================================== */
